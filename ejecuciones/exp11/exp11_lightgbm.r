...
PARAM$finalmodel$optim$num_iterations <- 1485
PARAM$finalmodel$optim$learning_rate <- 0.0279005117900015
PARAM$finalmodel$optim$feature_fraction <- 0.837034888597243
PARAM$finalmodel$optim$min_data_in_leaf <- 14009
PARAM$finalmodel$optim$num_leaves <- 402
