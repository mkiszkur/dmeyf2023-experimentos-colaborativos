...
PARAM$experimento <- "HTexp5"

#PARAM$input$dataset <- "./datasets/Datasets/Experimentos_colaborativos/df_cleaned_experimento_colaborativo.csv.gz"

# Para las BO, siempre testeamos en 202105, validamos en 202104, y entrenamos en distintos meses que varían
# corrida a corrida.
