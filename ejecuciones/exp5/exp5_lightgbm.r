...
PARAM$experimento <- "ECS005"

PARAM$input$dataset <- "./datasets/Experimentos_colaborativos/df_cleaned_experimento_colaborativo.csv.gz"


# meses donde se entrena el modelo
PARAM$input$training <- c(201907, 201908, 201909, 201910, 201911, 201912, 202001, 202002,
...
PARAM$finalmodel$optim$num_iterations <- 1543
PARAM$finalmodel$optim$learning_rate <- 0.0200130646755243
PARAM$finalmodel$optim$feature_fraction <- 0.664193416692091
PARAM$finalmodel$optim$min_data_in_leaf <- 12596
PARAM$finalmodel$optim$num_leaves <- 461
