...
PARAM$experimento <- "ECS_LGBM_013"
...
PARAM$finalmodel$optim$num_iterations <- 1153
PARAM$finalmodel$optim$learning_rate <- 0.043101552578737
PARAM$finalmodel$optim$feature_fraction <- 0.783719447433541
PARAM$finalmodel$optim$num_leaves <- 24
PARAM$finalmodel$optim$min_data_in_leaf <- 14711
