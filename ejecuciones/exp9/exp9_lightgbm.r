...
PARAM$finalmodel$optim$num_iterations <- 1810
PARAM$finalmodel$optim$learning_rate <- 0.0380374937226431
PARAM$finalmodel$optim$feature_fraction <- 0.715331298662442
PARAM$finalmodel$optim$min_data_in_leaf <- 11132
PARAM$finalmodel$optim$num_leaves <- 53
