...
PARAM$finalmodel$optim$num_iterations <- 940
PARAM$finalmodel$optim$learning_rate <- 0.0319925148210219
PARAM$finalmodel$optim$feature_fraction <- 0.649008855735906
PARAM$finalmodel$optim$min_data_in_leaf <- 10197
PARAM$finalmodel$optim$num_leaves <- 394
