...
PARAM$finalmodel$optim$learning_rate <- 0.0592826141083628
PARAM$finalmodel$optim$feature_fraction <- 0.757677645187854
PARAM$finalmodel$optim$min_data_in_leaf <- 6598
...
#dataset <- fread('./datasets/Experimentos_colaborativos/df_cleaned_experimento_colaborativo.csv.gz', stringsAsFactors = TRUE)
