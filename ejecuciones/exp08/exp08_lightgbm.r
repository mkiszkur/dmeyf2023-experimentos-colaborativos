...
PARAM$experimento <- "ECS_LGBM_008"
...
PARAM$input$training <- c(202003, 202005, 202006, 202007, 202008, 
...
PARAM$finalmodel$optim$num_iterations <- 1509
PARAM$finalmodel$optim$learning_rate <- 0.0203626098628976
PARAM$finalmodel$optim$feature_fraction <- 0.880339113611593
PARAM$finalmodel$optim$num_leaves <- 402
PARAM$finalmodel$optim$min_data_in_leaf <- 27134
