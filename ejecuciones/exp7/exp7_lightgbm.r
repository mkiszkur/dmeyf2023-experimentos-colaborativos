...
PARAM$finalmodel$optim$num_iterations <- 2289
PARAM$finalmodel$optim$learning_rate <- 0.0209557772437983
PARAM$finalmodel$optim$feature_fraction <- 0.915202774163544
PARAM$finalmodel$optim$min_data_in_leaf <- 25637
PARAM$finalmodel$optim$num_leaves <- 595
